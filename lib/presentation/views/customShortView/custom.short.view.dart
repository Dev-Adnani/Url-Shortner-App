...
class CustomShortView extends StatelessWidget {
  CustomShortView({Key? key}) : super(key: key);
    ...
    _userLogin() {
      if (_formKey.currentState!.validate()) {
        shortnerCubit.customUrl(
          ...
          customText: shortCodeController.text,
          context: context,
        );
      }
    }
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: CustomTextField.customTextField(
                            ...
                            hintText: 'Enter Short Code here',
                            validator: (val) =>
                                val!.isEmpty ? 'Enter Short Code here' : null,
                          ),
                        )
                      ],
                    ),
